   ...
   <script type="text/javascript">
        function ShowImagePreview(input) {
            if (input.files && input.files[0]) {
                ...
                $('#<%=ImgPrv.ClientID%>').css('display', 'inline-block');
                ...
                reader.readAsDataURL(input.files[0]);
                 ...
                 $('#<%=ImgPrv.ClientID%>').css('display', 'none');
            }
            }
    </script>
...
<body>
    ...
    <div class="form-group">
       ...
       <asp:Textbox ID="txtname" class="form-control" runat="server"/>
        <label><asp:RequiredFieldValidator ID="RequiredFieldValidator1" ErrorMessage="Required" ForeColor="Red" ControlToValidate="txtname"
                runat="server" /></label>
    </div>
              <div class="form-group">
 ...
 <asp:TextBox ID="txtEmail" class="form-control" runat="server" />
        ...
        <label for="confirmpass">Add Image</label>
                 <div class="form-group">
         <asp:Image ID="ImgPrv" Height="150px" Width="240px" runat="server" style="display:none" />
            <asp:FileUpload ID="imgUpload" runat="server" onchange="ShowImagePreview(this);" />
                  </div>
    </div>
         
 <asp:Button Text="Save" runat="server"   class="btn btn-primary submitbutton" ID="submitButton" OnClick="submitButton_Click"/>
</form>
